...
const Circle = ({textCenter,textBottom,textBottomTwo,textBottomThree,isActive}:Props) => {
  ...
  return (
    <div className=' w-[170px]   flex flex-col items-center'>
      ...
      <div className={`${isActive ? 'text-redMain':'text-[#CCC]'} flex flex-col justify-center items-center`}>
        <p>{textBottom}</p>
        <p>{textBottomTwo}</p>
        <p>{textBottomThree}</p>
      </div>
